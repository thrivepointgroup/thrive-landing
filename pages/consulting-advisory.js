export default function ConsultingAndAdvisory() {
    const services = [
      ...
      },
      {
        ...
        description:
          "We can integrate with your team to contribute code directly to your core codebase. In addition to delivering high-quality code, we provide strategic advisory to help improve your team's shipping speed, quality, and processes.",
      },
      {
        title: "Technical Interviewing and Screening",
        description:
          "Effectively screen technical engineering candidates. Our experience hiring engineers at places like Coinbase and various startups ensures a robust evaluation process.",
      },
      {
        title: "CTO as a Service",
        description:
          "A longer-term embedded role where we step in as acting CTO to build out the initial version of your product and help hire the technical team to drive it forward.",
      },
      {
    ...
    return (
      <div className="max-w-[800px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-12">
          ...
          <p className="text-lg">
            We charge top rate pricing for our consulting and advisory services, tailored to the complexity and scope of your project. Often, we begin engagements with a brief complimentary period so that you can experience our approach before transitioning to our standard rates.
          </p>
        </section>
